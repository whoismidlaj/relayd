        ...
        actions={
          <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
              <Button data-testid="add-domain-button"><Plus className="h-4 w-4" /> Add domain</Button>
            </DialogTrigger>
            <DialogContent data-testid="add-domain-dialog">
              ...
              <form onSubmit={createDomain} className="space-y-4">
                ...
                <DialogFooter>
                  <Button type="submit" data-testid="add-domain-submit">Create domain</Button>
                </DialogFooter>
              </form>
            </DialogContent>
          </Dialog>
          ...
          <TableBody data-testid="domains-table-body">
            ...
            {domains.map((d) => (
              <TableRow key={d.id} data-testid={`domain-row-${d.name}`}>
                ...
                <TableCell className="font-mono text-xs text-muted-foreground">{d.dkim_selector}</TableCell>
                <TableCell>
